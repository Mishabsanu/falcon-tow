...
export default function Expenses() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      {/* Active Filter Chips */}
      {(filters.worker !== 'All' || filters.vehicle !== 'All' || filters.startDate || filters.endDate) && (
        <div className="flex flex-wrap items-center gap-3 mb-8 animate-in fade-in slide-in-from-left-4 duration-500">
          <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 mr-2">Applied Expense Filters:</span>
          ...
          <button 
            onClick={() => {
              setFilters({ worker: 'All', vehicle: 'All', startDate: '', endDate: '' });
            }}
