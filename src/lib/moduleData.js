export const moduleData = {
  ...
  invoices: {
    ...
    fields: [
      ...
      { name: 'date', label: 'Billing Date', type: 'date', span: 4, section: 'Financial Details' },
      { name: 'type', label: 'Payment Type', type: 'select', options: ['Cash', 'Card', 'Bank Transfer', 'Credit'], defaultValue: 'Credit', span: 4, section: 'Financial Details' },
      { name: 'total', label: 'Service Charge (QAR)', type: 'number', defaultValue: 0, span: 4, section: 'Financial Details', readOnly: true },
      { name: 'totalHiddenCharges', label: 'Total Hidden Charges (QAR)', type: 'number', defaultValue: 0, span: 4, section: 'Financial Details', readOnly: true, required: false },
      { name: 'totalCharges', label: 'Net Payable Amount (QAR)', type: 'number', defaultValue: 0, span: 4, section: 'Financial Details', readOnly: true },
  ...
  quotations: {
    ...
    fields: [
      ...
      { name: 'customerVehicle', label: "Customer's Vehicle Name", type: 'text', span: 4, section: 'Client & Logistics', required: false },
  ...
  tows: {
    ...
    fields: [
      ...
      { name: 'customerVehicle', label: "Customer's Vehicle Name", type: 'text', span: 4, section: 'Towed Vehicle Details', required: false },
      { name: 'customerPlate', label: "Customer's Vehicle Plate Number", type: 'text', span: 4, section: 'Towed Vehicle Details', required: false },
  ...
  salaries: {
    ...
    fields: [
      ...
      { name: 'credit10', label: 'Credit 10%', type: 'number', readOnly: true, defaultValue: 0 },
      { name: 'credit90', label: 'Credit 90%', type: 'number', readOnly: true, defaultValue: 0 },
      { name: 'cash10', label: 'Cash 10%', type: 'number', readOnly: true, defaultValue: 0 },
      { name: 'cash90', label: 'Cash 90% (Hand Cash)', type: 'number', readOnly: true, defaultValue: 0 },
